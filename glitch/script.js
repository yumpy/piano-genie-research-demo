...
const MAPPING_6 = {0:0, 1:1, 2:3, 4:5, 6:6, 7:7};
...
function initEverything() {
  ...
  document.getElementById('numButtons6').addEventListener('change', (event) => event.target.checked && updateNumButtons(6));
